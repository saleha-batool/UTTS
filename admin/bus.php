...
require_once('connection.php'); 
 ...
 <html>  
  ...
  <div class="container">
	        <h3 align="center">Busses Details</h3>  
	<br/>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">ADD NEW BUS</h4>
      </div>
      <div class="modal-body">
       <div class="form-group">
		   <label>Enter Bus Number</label> 
	  <input type="text" name="number" id="number" placeholder="Enter Bus Number" class="form-control" required />
	   </div>
		<div class="form-group">
	  <label>Enter Bus registeration No</label>  
         <input type="text" name="register_no" id="register_no" placeholder="Enter Bus registeration No" class="form-control" required />
	   </div>
		<div class="form-group">
	   <label>Select Driver </label>  
       <input type="text" name="driver" id="driver" placeholder="Select Driver" class="form-control" required />
	   </div>
		<div class="form-group">
      ...
      <div class="modal-footer">
		 <button type="submit" class="btn btn-primary" id="addnew" >Add record</button>
...
<script type = "text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click', '#addnew', function(){
	        ...
	        $status=$('#status').val();
				$.ajax({
					...
					url: "bus-insert.php",
					data: {
						number:$number,register_no:$register_no,driver:$driver,status:$status,
						add:1,
					},
		...
		$(document).on('click', '.update', function(){
			...
			$number=$('#number-'+$uid).val();
            $register_no=$('#register_no'+$uid).val();
            $driver=$('#driver'+$uid).val();
