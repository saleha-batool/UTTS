        ...
        <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Students </a>
                    </li>
					<li>
                        <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Routes </a>
                    </li>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
	  ...
	  <label>Enter Details</label>  
		...
		<div class="form-group">
	   <label>Select Bus id</label>  
		<?php 
		$query=mysqli_query($con,"Select id from bus");
		?>	
      <select class="form-control" id="bus">
	<?php while($row=mysqli_fetch_array($query)){  ?>		  
      <option value="<?php $id=$row['id']; ?>">
	  <?php echo $id=$row['id']; ?>
      </option>
	<?php } ?>
      </select>	
       ...
       <input type="text" name="map" id="map" placeholder="Enter Map Image" class="form-control" required />
	   </div>
		<div class="form-group">
