...
<div class="modal fade" id="add_Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
	  ...
	  <input type="text" name="name" id="name" placeholder="Enter drivers name" class="form-control" required />
	   </div>
		<div class="form-group">
	  <label>Enter phone no</label>  
       ...
       <input type="text" name="cnic" id="cnic" placeholder="Enter cnic" class="form-control" required />
	   </div>
		<div class="form-group">
		...
		$(document).on('click', '#addnew', function(){
	        ...
	        $status=$('#status').val();
				$.ajax({
					...
					url: "insert.php",
					data: {
						name:$name,phone:$phone,cnic:$cnic,address:$address,status:$status,
						add:1,
					},
